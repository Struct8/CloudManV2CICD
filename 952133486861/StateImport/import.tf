...
import {
  to = aws_route.project-rtb-public_rtb_018e0442daf6e3ded_0_0_0_0_0
...
import {
  to = aws_route_table_association.project-rtb-public_subnet_03341dacbf8e734c4_rtb_018e0442daf6e3ded
  id = "subnet-03341dacbf8e734c4/rtb-018e0442daf6e3ded"
}

import {
  to = aws_route_table_association.project-rtb-public_subnet_06f1eb436fa1a94bd_rtb_018e0442daf6e3ded
